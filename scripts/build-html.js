...
<style>
:root{--cyan:#00E5FF;--orange:#FF6D00;--bg:#0a0e1a;--surface:#111827;--surface2:#1a2236;--text:#e2e8f0;--muted:#64748b;--success:#10b981;--danger:#ef4444;--green:#39ff14;}
...
.sub{color:var(--muted);font-size:0.88rem;margin-bottom:6px;}
.domain{color:var(--green);font-size:0.95rem;font-family:'Share Tech Mono',monospace;font-weight:700;text-shadow:0 0 8px rgba(57,255,20,0.6);margin-bottom:28px;display:block;}
