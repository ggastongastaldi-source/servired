const MAPA = {
  ...
  'techador':'techistas','techista':'techistas',
  'impermeabilizar':'antihumedad','humedad':'antihumedad','goteras':'antihumedad',
  'pvc':'revestimientos_pvc','cielorraso':'revestimientos_pvc',
  'aire acondicionado':'climatizacion','split':'climatizacion','estufa':'climatizacion','calefaccion':'climatizacion',
  'auxilio':'mecanica_auxilio','mecanica':'mecanica_auxilio',
  'consorcio':'mantenimiento_consorcios','edificio':'mantenimiento_consorcios',
  'solar':'paneles_solares','paneles':'paneles_solares',
  'perro':'peluqueria_canina','canino':'peluqueria_canina','mascota':'peluqueria_canina',
  'cucarachas':'fumigacion','plagas':'fumigacion','fumigador':'fumigacion','bichos':'fumigacion',
